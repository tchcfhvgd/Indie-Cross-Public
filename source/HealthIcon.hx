...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		if ((character == 'devilFull' && FlxG.save.data.secretChars[0] || character == 'papyrus' && FlxG.save.data.secretChars[1]
			...
			|| character == 'bendyDA' && FlxG.save.data.secretChars[4] || character == 'cupheadNightmare' && FlxG.save.data.secretChars[5]
			|| character == 'sansNightmare' && FlxG.save.data.secretChars[6] || character == 'bendyNightmare' && FlxG.save.data.secretChars[7])
